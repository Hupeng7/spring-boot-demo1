DROP TABLE IF EXISTS `orm_user_jpa`;
CREATE TABLE `orm_user_jpa` (
...
DROP TABLE IF EXISTS `orm_department_jpa`;
CREATE TABLE `orm_department_jpa` (
  `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
...
DROP TABLE IF EXISTS `orm_user_dept_jpa`;
CREATE TABLE `orm_user_dept_jpa` (
  `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
