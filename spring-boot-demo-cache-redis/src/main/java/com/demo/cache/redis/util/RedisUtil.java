package com.demo.cache.redis.util;
...
public class RedisUtil {
     ...
     * @return 成功个数
     */
    public long sSet(String key, Object... valus) {
        try {
            return redisTemplate.opsForSet().add(key, valus);
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public boolean zAdd(String key, Object value, double score) {
        try {
            ...
            Boolean add = redisTemplate.opsForZSet().add(key, toJson(value), score);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public Set<Object> zRange(String key) {
        try {
            //Set<ZSetOperations.TypedTuple<Object>> typedTuples = redisTemplate.opsForZSet().rangeByScoreWithScores(key, 0, -1);
            Set<Object> objects = redisTemplate.opsForZSet().rangeByScore(key, 0, -1);
            return objects;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public static <T> List<T> parseJsonList(List<Object> list, Class<T> clazz) {
        if (list == null) {
            return null;
        }
