package com.demo.orm.beetlsql.service.impl;

import cn.hutool.core.util.ObjectUtil;
import com.demo.orm.beetlsql.dao.UserDao;
import com.demo.orm.beetlsql.entity.User;
import com.demo.orm.beetlsql.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public User updateUser(User user) {
        if (ObjectUtil.isNull(user)) {
            throw new RuntimeException("用户id 不能为null");
        }
