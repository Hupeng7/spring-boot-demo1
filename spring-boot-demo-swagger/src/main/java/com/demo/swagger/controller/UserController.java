...
import com.demo.swagger.common.ApiResponse;
import com.demo.swagger.common.DataType;
import com.demo.swagger.common.ParamType;
...
public class UserController {
    ...
    public void delete(@PathVariable Integer id) {
        log.info("单个参数用@ApiImplicitParam,delelte object's id is " + id);
    }
    ...
    public void put(@PathVariable Long id, @RequestBody User user) {
        log.info("如果你不想写 @ApiImplicatParam 那么swagger 也会使用默认的参数名作为描述信息");
    }
