 ...
 */
@Component
public class FormModelSubmitHandler implements FormSubmitHandler<Serializable> {
    ...
    public Map<String, Serializable> handleSubmit(FormSubmitRequest request) {
        logger.info("模型模式提交：userId={},formInput={}",request.getUserId(),request.getFormInput());
        return null;
    }
}
