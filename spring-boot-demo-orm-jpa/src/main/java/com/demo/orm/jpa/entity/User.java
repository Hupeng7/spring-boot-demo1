...
public class User extends AbstractAuditModel {
    ...
    @JoinTable(name = "orm_user_dept_jpa", joinColumns = @JoinColumn(name = "user_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "dept_id", referencedColumnName = "id"))
