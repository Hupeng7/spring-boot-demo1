...
public class JsonDemo {
    public static void main(String[] args) {
        ...
        List<com.example.springbootdemomytool.utils.jsondemo.Person> peoples = new JsonDemo().jsonToList(jsonArray);
        System.out.println("peoples: " + peoples);
        String s = new JsonDemo().listToJson(peoples);
        System.out.println("s: " + s);
    }

    public List<com.example.springbootdemomytool.utils.jsondemo.Person> jsonToList(String jsonArray) {
        //json转换为list
    ...
    public String listToJson(List<com.example.springbootdemomytool.utils.jsondemo.Person> list) {
        //list转换为json
        //List<Person> list = new ArrayList<Person>();
