package com.demo.task.quartz.controller;

import cn.hutool.core.lang.Dict;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.demo.task.quartz.common.ApiResponse;
...
public class JobController {
    ...
    public ResponseEntity<ApiResponse> pauseJob(JobForm form) throws SchedulerException {
        ...
        return new ResponseEntity<>(ApiResponse.msg("暂定成功"), HttpStatus.OK);
    }
