...
public class ActiveRecordTest extends SpringBootDemoOrmMybatisPlusApplicationTests {
    ...
    public void testActiveRecordDelete() {
        ...
        Assert.assertTrue(new Role().delete(new QueryWrapper<Role>().lambda().eq(Role::getId, "普通用户")));
    }
