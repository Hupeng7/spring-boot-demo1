...
#### 添加一个module
 ...
 ```$xslt
markdown语法——插入图片
原创aaon22357 最后发布于2018-12-03 10:45:18 阅读数 4107  收藏
展开
该方法适用于所有适用markdown语法编辑器，csdn和typora都可以！

1.设置插入图片的大小
我们发现，直接插入的图片时，语法是这样的：
![1](/home/aaon/文档/assets/1543803099995.png)

想要对图片进行缩放，先要将其转换成html语法，然后对img的width或height属性进行修改：

修改width：
<img src="/home/aaon/文档/assets/1543803099995.png" width="200px" />   
或者修改height：
<img src="/home/aaon/文档/assets/1543803099995.png" style="height:200px" />
也可以直接按比例缩放：
<img src="/home/aaon/文档/assets/1543803099995.png" style="zoom:70%" />

2. 使用图片的相对路径
如果用typora这类笔记软件的话，我们会有不同客户端同步的需求。如果使用绝对路径的话，往往文字同步，但是图片不能同步。为了解决这一问题，需要使用图片的相对路径。

假定我当前的工作目录是“/home/aaon/文档”，图片在下面的“assets"文件夹下的“1543803099995.png”，使用相对路径是这样的：

<img src="./assets/1543803099995.png" style="zoom:70%" />
————————————————
```

#### 高性能短链设计
```$xslt
https://mp.weixin.qq.com/s/bVUQwgtziN06M-aiGB-zfw
