DROP TABLE IF EXISTS `orm_user_mybatis_plus`;
CREATE TABLE `orm_user_mybatis_plus` (
...
DROP TABLE IF EXISTS  `orm_role_mybatis_plus`;
CREATE TABLE `orm_role_mybatis_plus` (
  `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
